    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <h3 className="text-lg font-semibold mt-6 mb-3">Information Collected while Using the Application</h3>
          <p>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4">Use of Your Personal Data</h2>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4">Retention of Your Personal Data</h2>
          <p>
            The Company will retain Your Personal Data only for as long as necessary for the
            purposes set out in this Privacy Policy.
          </p>

          <h2 className="text-xl font-semibold mt-8 mb-4">Disclosure of Your Personal Data</h2>
