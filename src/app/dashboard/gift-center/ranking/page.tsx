...
export default function RankingPage() {
  ...
  const rankingIcons = [
    ...
    { icon: BlueRankIcon, label: 'Platinum', points: 200, rankKey: 'platinum' as const },
    { icon: PinkRankIcon, label: 'Diamond', points: 200, rankKey: 'diamond' as const },
    { icon: RedRankIcon, label: 'Top Member', points: 200, rankKey: 'topMember' as const },
  ]
  ...
  const getRankIcon = (rankKey?: 'bronze' | 'silver' | 'gold' | 'platinum' | 'diamond' | 'topMember') => {
  ...
  const topMembers = [
    { rank: 1, name: 'Sara Ahmed', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100', crown: 'gold' },
    { rank: 2, name: 'Sara Ahmed', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100', crown: 'silver' },
    { rank: 3, name: 'Sara Ahmed', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100', crown: 'bronze' },
    { rank: 4, name: 'Aya Mohamed', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100', rankText: 'New Member', rankKey: 'bronze' as const },
    { rank: 5, name: 'Mohamed Ali', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100', rankText: 'New Member', rankKey: 'silver' as const },
    { rank: 6, name: 'Fatima Hassan', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100', rankText: 'New Member', rankKey: 'gold' as const },
    { rank: 7, name: 'Omar Ibrahim', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100', rankText: 'New Member', rankKey: 'platinum' as const },
    { rank: 8, name: 'Layla Ahmed', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100', rankText: 'New Member', rankKey: 'diamond' as const },
    { rank: 9, name: 'Youssef Mostafa', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100', rankText: 'New Member', rankKey: 'topMember' as const },
  ]
          ...
          <div className=" rounded-lg sm:rounded-xl border-2 border-gray-200 p-4 sm:p-5  flex flex-col items-center gap-3 sm:gap-4">
            ...
            <div className="text-center">
              <h3 className="text-12 sm:text-14 font-normal text-gray-400 mb-1">
                Current Rank <span className="text-gray-900 font-semibold">{currentRank.label}</span>
              </h3>
              <p className="text-12 sm:text-14 text-gray-400">Total Points : {currentRank.points} Points</p>
            </div>
          </div>
        </div>
                      ...
                      <Image
                        src={
                          member.crown === 'gold'
                            ...
                            : member.crown === 'silver'
                              ? (typeof blueCrown === 'string' ? blueCrown : blueCrown.src)
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-1.5 sm:gap-2">
                      ...
                      {(() => {
                        ...
                        return <RankIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0" />
                      })()}
                    </div>
