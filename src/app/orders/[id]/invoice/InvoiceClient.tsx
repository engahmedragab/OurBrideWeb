...
export function InvoiceClient({ orderId }: InvoiceClientProps) {
  ...
  const {
    ...
    isLoading,
    error,
  } = useOrderInvoice(isNaN(orderIdNum) ? null : orderIdNum, {
        ...
        <ErrorDisplay
          ...
          message={
            error instanceof Error
              ? error.message
              : 'The invoice for this order could not be loaded'
          }
    ...
    <UserPageLayout>
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <PageHeader
            title={`Invoice #${invoice.orderNumber || invoice.orderId}`}
          />
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm print:shadow-none">
        ...
        <div className="flex justify-between items-start mb-8 pb-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-14 text-gray-600">
              Order #{invoice.orderNumber || invoice.orderId || 'N/A'}
            </p>
            {orderDate && (
          ...
          <div className="text-right">
            ...
            <div>
              ...
              {!invoice.billingName &&
                ...
                (!invoice.billingAddress ||
                  invoice.billingAddress === ', , ') && (
                  <p className="text-14 text-gray-500 italic">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left py-3 px-4 text-14 font-semibold text-gray-900">
                    Item
                  </th>
                  <th className="text-right py-3 px-4 text-14 font-semibold text-gray-900">
                    Quantity
                  </th>
                  <th className="text-right py-3 px-4 text-14 font-semibold text-gray-900">
                    Price
              ...
              <tbody>
                ...
                invoice.items.length > 0 ? (
                  ...
                  <tr>
                    <td
                      colSpan={4}
                      className="py-4 text-center text-14 text-gray-500"
                    >
                      No items found
                    </td>
                  </tr>
          ...
          <div className="w-full max-w-md space-y-2">
            <div className="flex justify-between text-14 text-gray-700">
              ...
              <span className="font-medium">
                {invoice.totalAmount?.toLocaleString() || '0'} EGP
              </span>
            </div>
            ...
            {invoice.depositAmount !== null &&
              ...
              invoice.depositAmount > 0 && (
                <div className="flex justify-between text-14 text-gray-700">
                  <span>Deposit:</span>
                  <span className="font-medium">
                    {invoice.depositAmount.toLocaleString()} EGP
                  </span>
                </div>
              )}
        ...
        {(invoice.paymentMethod ||
          ...
          <div className="mb-6 p-4 bg-gray-50 rounded-lg">
            <h3 className="text-16 font-semibold text-gray-900 mb-3">
              Payment Information
            </h3>
            <div className="grid grid-cols-2 gap-4 text-14 text-gray-700">
              ...
              {invoice.paymentAmount !== null &&
                invoice.paymentAmount !== undefined && (
                  <div>
                    <span className="font-medium">Payment Amount:</span>{' '}
                    {invoice.paymentAmount.toLocaleString()} EGP
                  </div>
                )}
            </div>
          </div>
        ...
        {invoice.hasPaymentPlan && (
          <div className="mb-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4 text-14 text-gray-700">
              ...
              {invoice.numberOfPayments !== null &&
                invoice.numberOfPayments !== undefined && (
                  <div>
                    <span className="font-medium">Number of Payments:</span>{' '}
                    {invoice.numberOfPayments}
                  </div>
                )}
              {invoice.paymentAmount !== null &&
                invoice.paymentAmount !== undefined && (
              ...
              {invoice.firstPaymentDate && (
                <div>
                  ...
                  {new Date(invoice.firstPaymentDate).toLocaleDateString(
                    'en-GB'
                  )}
                </div>
              )}
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <div className="flex flex-col items-center justify-center gap-2">
              <div className="relative w-40 h-20">
                <Image
                  src={
                    typeof brandLogo === 'string' ? brandLogo : brandLogo.src
                  }
                  alt="OurBride Logo"
                  fill
                  sizes="160px"
