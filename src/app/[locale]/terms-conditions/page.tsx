    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-8">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
          <p>
          ...
          <p>The laws of Egypt shall govern these Terms and Your use of the Service.</p>

          <h2 className="text-xl font-semibold mt-8 mb-4">Disputes Resolution</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4">Changes to These Terms and Conditions</h2>
          <p>
