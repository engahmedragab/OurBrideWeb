...
export const ANALYTICS_CONFIG = {
    ...
    // Format: G-XXXXXXXXXX
    GA4_MEASUREMENT_ID: import.meta.env.VITE_GA4_MEASUREMENT_ID || import.meta.env.REACT_APP_GA4_MEASUREMENT_ID || 'G-MYD76K35ER',

    // Meta Pixel (Facebook) ID
    // Format: 123456789012345
    META_PIXEL_ID: import.meta.env.VITE_META_PIXEL_ID || import.meta.env.REACT_APP_META_PIXEL_ID || '2239144796518215',

    // TikTok Pixel ID
    // Format: CXXXXXXXXXXXXXXX
    TIKTOK_PIXEL_ID: import.meta.env.VITE_TIKTOK_PIXEL_ID || import.meta.env.REACT_APP_TIKTOK_PIXEL_ID || 'D30S3HRC77U7TGIRB35G',
