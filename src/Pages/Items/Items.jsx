...
import { imgsArray } from "../../Components/ItemsCard/ItemsCard";
      ...
      <div className="container">
        <div className="contain m-5 w-100 d-flex flex-column justify-content-center align-items-center">
          ...
          <h2 className="fw-light">
            <span className="fw-semibold">Items </span> Gallery.
          </h2>
        </div>
        <ul
          className="nav nav-pills d-flex justify-content-center my-2"
          id="pills-tab"
          role="tablist"
        >
