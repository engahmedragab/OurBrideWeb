...
export const createEventBookCategory = async (
  ...
  try {
    ...
    throw new Error(
      error instanceof Error
        ? error.message
        : 'Failed to create event book category'
    )
  }
}
...
export const createEventBookEventLine = async (
  ...
  try {
    ...
    throw new Error(
      error instanceof Error
        ? error.message
        : 'Failed to create event book event line'
    )
  }
}
...
export const getEventBooks = async (params?: {
  ...
  try {
    ...
    throw new Error(
      error instanceof Error ? error.message : 'Failed to fetch event books'
    )
  }
}
...
export const getEventBooksCategories = async (query?: {
  ...
  try {
    ...
    if (
      ...
      'data' in responseAny.data
    ) {
      const nestedData = (responseAny.data as { data?: EventLineCategory[] })
        .data
    ...
    throw new Error(
      error instanceof Error
        ? error.message
        : 'Failed to fetch event book categories'
    )
  }
}
...
export const deleteEventBookCategory = async (
  ...
  try {
    ...
    throw new Error(
      error instanceof Error
        ? error.message
        : 'Failed to delete event book category'
    )
  }
}
