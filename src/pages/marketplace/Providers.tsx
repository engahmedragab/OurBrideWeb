    ...
    const fetchData = async () => {
      try {
        ...
        const [statsData, featuredProvidersData, preparationsData] = await Promise.all([
          statisticsService.getOverview().catch(() => null),
          providerService.getFeatured(6).catch(() => []),
          preparationService.getFeatured().catch(() => []),
        ]);
        ...
        if (statsData) {
          ...
          setPlatformStats({
            totalProviders: stats.verifiedProviders || stats.totalProviders || 0,
            verifiedProviders: stats.verifiedProviders || 0,
            averageRating: stats.averageRating || 0,
            totalHappyCouples: stats.totalHappyCouples || stats.totalUsers || 0,
          });
        }

        // Set featured providers for carousel
        const providers = Array.isArray(featuredProvidersData)
          ? featuredProvidersData
          : featuredProvidersData?.data || featuredProvidersData || [];
        ...
        <div className="provider-card">
          <div className="provider-image">
            <img
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src = "https://via.placeholder.com/400x300?text=Provider";
              }}
            />
            {provider.isVerified && (
  ...
  return (
    <>
      <div className="providers-section">
        <SEOHead
          title="Wedding Providers - OurBride Marketplace"
          description="Connect with verified and trusted wedding service providers. From photographers to venues, find the perfect partners for your special day."
          keywords="wedding providers, wedding vendors, wedding services, verified providers, marketplace"
          image=""
        ...
        {/* Hero Section */}
        <HeroSection
          title="Our <span class='text-gradient'>Wedding Providers</span>"
          description="Connect with verified and trusted wedding service providers. From photographers to venues, find the perfect partners for your special day."
          badge={{ icon: "fas fa-handshake", text: "Trusted Partners" }}
          particles={true}
        />
              ...
              <div className="col-lg-10">
                <div className="hero-stats d-flex justify-content-center gap-5 flex-wrap">
                  <div className="stat-item text-center">
                    <div className="stat-number display-6 fw-bold text-main">
                    ...
                    <div className="stat-label text-muted">Verified Providers</div>
                  </div>
                  <div className="stat-item text-center">
                    <div className="stat-number display-6 fw-bold text-main">
                  ...
                  <div className="stat-item text-center">
                    ...
                    <div className="stat-label text-muted">Happy Couples</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="providers-carousel-section py-5 bg-light">
          <div className="container">
            <SectionHeader
              title="Top Wedding Service Providers"
              description="Discover our handpicked selection of premium wedding service providers. Each one is verified and highly rated by our community."
              badge={{ icon: "fas fa-star", text: "Featured Providers" }}
            />
        ...
        {/* Categories Section */}
        <section className="provider-categories-section py-5">
          <div className="container">
            <SectionHeader
              title="Browse by Category"
              description="Find the perfect wedding services organized by category"
              ...
              <div className="col-lg-8">
                <div className="cta-content">
                  ...
                  <div className="cta-buttons d-flex justify-content-center flex-wrap gap-3">
                    <Link to="/preparations" className="btn btn-main btn-lg">
                      <i className="fas fa-th-large me-2"></i>
                      Browse Preparations
                    </Link>
                    <Link to="/services" className="btn btn-main btn-lg">
