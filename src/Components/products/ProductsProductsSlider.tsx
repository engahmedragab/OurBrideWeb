...
/**
 * Product interface for products slider
 */
...
export interface ProductsProductsSliderProps {
  products: Product[]
  className?: string
}

/**
 * ProductsProductsSlider Component
 * 
 ...
 */
export const ProductsProductsSlider = ({
  products,
  className,
}: ProductsProductsSliderProps) => {
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      {products.length > 3 && (
        <>
          <button
            className="swiper-button-prev-products absolute left-0 top-1/2 -translate-y-1/2 z-10 w-8 h-8 rounded-full bg-white border border-gray-200 hover:bg-brand-50 hover:border-brand-500 shadow-md flex items-center justify-center transition-all duration-200 hover:scale-110"
          ...
          <button
            className="swiper-button-next-products absolute right-0 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-white border border-gray-200 hover:bg-brand-50 hover:border-brand-500 shadow-md flex items-center justify-center transition-all duration-200 hover:scale-110"
