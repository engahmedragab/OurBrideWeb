...
export default function TermsAndConditions() {
  return (
    <div className="container mt-5">
      <h1 className="text-main fw-bolder">Terms and Conditions for OurBride</h1>
      <p>
      ...
      <ul>
        ...
        <li>
          <strong>Application Store</strong> refers to the digital distribution
          service operated by Apple Inc. (Apple App Store) or Google Inc.
        ...
        <li>
          <strong>Terms and Conditions</strong> mean these Terms and Conditions
      ...
      <p>
        ...
        of and compliance with these Terms and Conditions. By accessing or using
      ...
      <p>
        ...
        or indirectly, for any damage or loss caused by the use of any such
        content available on such websites or services.
      </p>
      ...
      <p>
        ...
        suppliers will not be liable for any incidental, indirect, or
      ...
      <p>
        ...
        warranties of any kind. The Company makes no warranties regarding the
        operation or availability of the Service.
      </p>
