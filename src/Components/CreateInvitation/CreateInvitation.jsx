      ...
      <div className="contain mt-3 cover-img">
        <div className="opicity-gray bg-light bg-opacity-50">
          <div className="text-center m-4 my-5">
            <Link to="/">
              <img src={logo} className="w-25 mt-3" />
            </Link>
            <h2 className="main-font fw-bolder my-4 ">
              CREATE OURBRIDE INVITATION
            </h2>
            <MainButton
              title="Open your invitaion"
              classes="btn-outline-main bg-transparent"
            />
            <p>or</p>
            ...
            <form onSubmit={SubmitData}>
              <div className="col-12">
                <label htmlFor="bride-name" className="mt-4 text-second fs-6">
                  Bride - اسم العروسة
                </label>
                <input
                  onChange={getData}
                  ...
                  name="bride-name"
                  id="bride-name"
                  className="form-control shadow-sm rounded-pill w-50 text-center mx-auto px-4"
                  placeholder="Name"
                />
              </div>
              <div className="col-12">
                <label htmlFor="groom-name" className="mt-4 text-second fs-6">
                  Groom - اسم العريس
                </label>
                <input
                  onChange={getData}
              ...
              <div className="col-12">
                <label htmlFor="wedding-date" className="mt-4 text-second fs-6">
              ...
              <div className="col-12">
                <label
                  ...
                  className="mt-4 text-second fs-6"
                >
              ...
              <div className="col-12">
                <label htmlFor="henna-date" className="mt-4 text-second fs-6">
                  Henna Date - تاريح الحنة
                </label>
                <input
                  onChange={getData}
                  required
              ...
              <div className="col-12">
                <label htmlFor="crown-date" className="mt-4 text-second fs-6">
                  Crown Date - تاريح كتب الكتاب \ الاكليل
                </label>
                <input
                  onChange={getData}
                  required
              ...
              <div className="col-12">
                <label htmlFor="area" className="mt-4 text-second fs-6">
                  Area - المنطقة
                </label>
                <input
                  onChange={getData}
              ...
              <div className="col-12">
                <label htmlFor="wedding-hole" className="mt-4 text-second fs-6">
                  Wedding hole - اسم قاعة الفرح
                </label>
                <input
                  onChange={getData}
                  required
              ...
              <div className="col-12">
                <label htmlFor="adress" className="mt-4 text-second fs-6">
              ...
              <div className="imgIcon d-flex justify-content-center row gx-5">
                <div className="col-lg-3 p-5">
                  <Link>
                    <img onClick={getImg} src={invita} className="w-100" />
                  </Link>
                </div>
                <div className="col-lg-3 p-5">
                  <Link>
                    <img onClick={getImg} src={invita2} className="w-100" />
                  </Link>
                </div>
                <div className="col-lg-3 p-5">
                  <Link>
                    <img onClick={getImg} src={invita3} className="w-100" />
                  </Link>
                </div>
                <div className="col-lg-3 p-5">
                  <Link>
                    <img onClick={getImg} src={invita4} className="w-100" />
                  </Link>
                </div>
              </div>
