     ...
     <div className="mt-3 w-100 text-center">
            <div className="img-border w-50 mx-auto position-relative text-secondary">
                ...
                <div className="position-absolute top-50 start-50  translate-middle  w-50">
                    ...
                    <p className="mb-4 fs-4 fw-bold text-card3">{invitaionData["wedding-hole"] }</p>
                    <p>{invitaionData["adress"] } , { invitaionData["area"]} </p>
                    <div className="d-flex justify-content-center">
                        <div className="d-flex flex-column fs-6 mx-3 mb-4">
                    ...
                    <p className='fs-6 mb-4 text-card3 fw-bold'>{WDate}</p>
                    <p className='fs-6 mb-4'>Crown Date تاريح كتب الكتاب<br/>{CDate}</p>
                    <p className='fs-6 mb-4'>Engagement Date تاريخ الخطوبة<br/>{EDate}</p>
                    <p className='fs-6 mb-4'>Henna Date تاريح الحنة<br/>{HDate}</p>
                    <p className='fs-6 mb-4 text-card3 fw-bold'>الف الف مبرووك للعروسين </p>
                </div>
            </div>
          <ShareBtns/>
    </div>
