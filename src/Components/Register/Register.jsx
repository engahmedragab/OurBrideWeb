...
export default function Register() {
  ...
  async function sendUserData() {
    let response = await axios.post(
      `http://161.35.32.218/api/v1/identity/register`,
      user
    );
          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              <form onSubmit={submitRegisterData} className="mt-5">
                ...
                <div className="">
                  <label htmlFor="firstName" className="mt-3 mb-0">
                    First Name
                  </label>
                  <input
                    required
                ...
                <div className="">
                  <label htmlFor="lastName" className="mt-3 mb-0">
                    Last Name
                  </label>
                  <input
                    required
                ...
                <div className="">
                  <label htmlFor="email" className="mt-3 mb-0">
                    Enter your Email
                  </label>
                  <input
                    ...
                    placeholder="Email"
                  />
                  <p className="alert-warning rounded">
                    {
                      errorList.filter(
                ...
                <div className="">
                  <label htmlFor="password" className="mt-3 mb-0">
                    Enter your Password
                  </label>
                  <input
                    onChange={getUserData}
                  ...
                  />
                  <p className="alert alert-danger rounded">
                    {errorList.filter((err) => err.context.label === "password")
