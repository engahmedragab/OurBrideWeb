        ...
        >
          ...
          <input
            ...
            className={cn(
              ...
              variant === 'default' && 'text-gray-300 placeholder:text-gray-300',
              variant === 'focused' && 'text-gray-900 placeholder:text-gray-900',
              variant === 'success' && 'text-gray-500 placeholder:text-gray-500',
              variant === 'fill' && 'text-gray-400 placeholder:text-gray-400'
            )}
            ref={ref}
            {...props}
          />
