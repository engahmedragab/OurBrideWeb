...
const statusConfig = {
  requestReceived: {
    ...
    description: "Your booking request has been sent to the provider. Please wait while they review it.",
    progressStep: 0,
  },
  underReview: {
    title: 'Provider is Reviewing',
    description: 'The provider is checking your request details. You\'ll get notified once they decide.',
    progressStep: 1,
  },
  confirmed: {
    title: 'Request Confirmed',
    description: 'Your request has been confirmed by the provider. You can proceed to checkout.',
    progressStep: 2,
  },
  completed: {
    title: 'Request Completed',
    description: 'Your request has been completed successfully. Thank you for choosing OurBride!',
    progressStep: 2,
  },
  cancelled: {
  ...
  return (
    <div className={cn('flex flex-col items-center gap-4', className)}>
      ...
      <div className="relative w-48 h-48 flex items-center justify-center">
        ...
        {status === 'underReview' && (
          <img
            src={typeof requestUnderReviewSvg === 'string' ? requestUnderReviewSvg : requestUnderReviewSvg.src}
            alt="Under Review"
            className="w-full h-full object-contain"
          />
        )}
