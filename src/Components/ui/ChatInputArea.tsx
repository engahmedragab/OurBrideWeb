        ...
        <div className="flex flex-wrap gap-2">
          {quickReplies.map((chip, index) => (
            <button
              ...
              className="bg-gray-50 rounded-xl px-3 py-2.5 text-16 font-normal leading-6 text-gray-500 hover:bg-gray-100 transition-colors"
            >
              {chip.text}
            </button>
          ))}
      ...
      <div className="flex gap-2 items-center">
        <div className="flex-1">
          <Input
            ...
            variant="fill"
            size="lg"
            prefixIcon={<Plus className="h-6 w-6 text-brand-500" />}
            disabled={disabled}
        ...
        <Button
          ...
          disabled={disabled}
          className={cn(
            'h-[60px] w-[60px] rounded-full flex-shrink-0',
