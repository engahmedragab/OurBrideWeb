...
export const BudgetCategoryCard = ({
  ...
  return (
    <div className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 overflow-hidden transition-all duration-200 hover:shadow-md">
      {/* Category Header */}
      <button
        onClick={onToggle}
        className="w-full flex items-center gap-2 sm:gap-3 md:gap-4 p-3 sm:p-4 md:p-5 hover:bg-gray-50 transition-colors"
      >
        {/* Category Icon */}
        <div className="flex-shrink-0 w-9 h-9 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg sm:rounded-xl border border-brand-500 flex items-center justify-center">
          {category.icon ? (
        ...
        <div className="flex-1 text-left min-w-0">
          <h3 className="text-14 sm:text-16 md:text-18 font-semibold text-gray-900 truncate">
            {category.name}
          </h3>
          <p className="text-12 sm:text-14 text-gray-500 mt-0.5">
        ...
        <div className="border-t border-gray-200 bg-gray-50">
          <div className="p-3 sm:p-4 md:p-5 space-y-3 sm:space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div>
                <p className="text-11 sm:text-12 text-gray-500 mb-1">
                  Estimated Cost
                </p>
                <p className="text-13 sm:text-14 md:text-16 font-semibold text-gray-900">
              ...
              <div className="space-y-3 pt-2">
                {category.items.map(item => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 border border-gray-200 hover:shadow-sm transition-shadow"
                    >
                      <div className="flex items-start justify-between gap-2 sm:gap-3 md:gap-4">
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-start justify-between gap-2 mb-2">
                            <h4 className="text-13 sm:text-14 lg:text-16 font-semibold text-gray-900 break-words flex-1">
                              {item.name}
                            </h4>
