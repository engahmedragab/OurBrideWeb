...
export const SummaryMetricCard = ({
  ...
  return (
    <div
      className={cn(
        'bg-white rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5 shadow-sm border border-gray-200',
          ...
          <div className="flex items-center gap-2">
            {editable && isEditing ? (
              <input
                ...
                className={cn(
                  'flex-1 rounded-xl border bg-white px-3 py-1.5 text-14 sm:text-16 lg:text-18 font-semibold border-gray-300 focus:border-brand-500 focus:outline-none focus:ring-0 transition-colors',
              ...
              <>
                <p
                  className={cn(
                    'text-16 sm:text-20 md:text-24 font-bold flex-1',
                    variant === 'highlight' ? 'text-brand-500' : 'text-gray-900'
                  )}
                >
                  {typeof value === 'number'
            ...
            <div className="flex items-center gap-2">
              {editableSub && isEditingSub ? (
                <input
                  ...
                  className="flex-1 rounded-xl border bg-white px-3 py-1.5 text-14 sm:text-16 lg:text-18 font-semibold border-gray-300 focus:border-brand-500 focus:outline-none focus:ring-0 transition-colors text-gray-900"
                  autoFocus
                />
              ) : (
                <>
                  <p className="text-14 sm:text-16 md:text-18 font-semibold text-gray-900 flex-1">
