    ...
    <div className="bg-white rounded-xl overflow-hidden shadow-md border border-gray-200">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/3 h-40 md:h-auto relative overflow-hidden">
          <Image
            src={imageSrc}
            alt={tCards('eventSummary.imageAlt')}
            fill
        ...
        <div className="md:w-2/3 p-4 md:p-6 relative">
          ...
          <div className={cn("absolute top-3 ", isRtl ? '!left-3' : '!right-3')}>
            <Link
              ...
              className="text-brand-500 hover:text-brand-600 text-12 font-medium"
            >
          ...
          <div className="mt-6 md:mt-0">
            <h1 className="text-22 sm:text-24 font-semibold text-gray-900 mb-2">
              {eventName}
            </h1>
            ...
            <div className="flex items-center gap-4">
              <div className="text-center">
                ...
                <p className="text-12 text-gray-600 mt-1">
                  {tCards('eventSummary.countdown.days')}
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-12 text-gray-600 mt-1">
                  {tCards('eventSummary.countdown.hours')}
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-12 text-gray-600 mt-1">
                  {tCards('eventSummary.countdown.minutesShort')}
                </p>
              </div>
            </div>
          </div>
