...
// Component to handle image errors per service
const ServiceListItem = ({ 
  ...
  return (
    <div className="group bg-white rounded-xl border border-gray-100 hover:shadow-lg transition-all duration-300 overflow-hidden">
