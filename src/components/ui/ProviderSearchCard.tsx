  ...
  return (
    ...
    >
      ...
      <div className="p-4 space-y-3">
        ...
        {/* Address */}
        {address && (
          <p className="text-14 text-gray-600 line-clamp-2">{address}</p>
        )}
        ...
        {displayServices.length > 0 && (
          <div className="space-y-2 pt-2">
            {displayServices.map((service, index) => {
              ...
              const serviceName =
                service.nameEn || service.nameAr || serviceAny.name || 'Service'
              const serviceNameAr =
              ...
              const originalPrice =
                service.hasDiscount && service.price ? service.price : undefined
