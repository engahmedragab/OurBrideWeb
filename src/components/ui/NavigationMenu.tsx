...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <ChevronDown
        className={cn(
          "relative top-[1px] h-4 w-4 transition duration-200 group-data-[state=open]:rotate-180",
          isRTL ? "mr-1" : "ml-1"
        )}
        aria-hidden="true"
      />
  ...
  >
    <NavigationMenuPrimitive.Viewport
      className={cn(
        ...
        'rounded-lg border border-gray-200 bg-white text-popover-foreground shadow-xl',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:zoom-out-95 data-[state=closed]:fade-out',
        'data-[state=open]:zoom-in-95 data-[state=open]:fade-in',
