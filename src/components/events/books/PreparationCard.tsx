 ...
 * Displays preparation (service) book with its lines
 */

import { cn } from '@/lib/utils'
import type { MainServiceBookResponse } from '@/types/responses'
          ...
          {activeLines.map(line => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                />
                <span className="text-14 text-gray-900">{line.title}</span>
              </div>
            </div>
          ))}
        </div>
