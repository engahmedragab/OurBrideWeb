          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <input
                  type="text"
                  placeholder={t('communityFeed.createPostPlaceholder', {
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    aria-label={t('communityFeed.aria.uploadImage')}
                  ...
                  <button
                    type="button"
                    className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:border-gray-400 transition-colors"
                    aria-label={t('communityFeed.aria.addReels')}
                    onClick={e => e.stopPropagation()}
                  >
                  ...
                  <button
                    type="button"
                    className="w-10 h-10 rounded-full border border-gray-300 flex items-center justify-center hover:border-gray-400 transition-colors"
                    aria-label={t('communityFeed.aria.textFormat')}
                    onClick={e => e.stopPropagation()}
                  >
      ...
      <div className="space-y-6">
        {posts.length > 0 ? (
          ...
          <CommunityEmptyState
            ...
            message={t('communityFeed.emptyMessage')}
            compact
          />
        )}
      </div>
