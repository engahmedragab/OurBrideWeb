...
export const ContestDetails = ({ contest, className }: ContestDetailsProps) => {
          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-14 text-gray-700 ml-2">
                  {contest.endDate ? formatDateShort(contest.endDate) : 'TBA'}
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="relative w-10 h-10 rounded-full overflow-hidden flex-shrink-0 bg-gray-200">
              <div className="w-full h-full flex items-center justify-center bg-brand-100">
                <span className="text-14 font-semibold text-brand-600">
                  {getUserDisplayName(contest.user).charAt(0).toUpperCase() ||
                    'U'}
                </span>
              </div>
            </div>
