 ...
 console.log({item})
  return (
    <div
      ...
      className={cn('rounded-xl border bg-white p-4 transition hover:bg-gray-50')}
    >
      ...
      <div className="min-w-0 mt-3">
        <div className={cn('text-sm font-medium text-gray-900 truncate', item.isDone && 'line-through text-gray-400')}>
        ...
        <div className="mt-3 flex flex-wrap items-center gap-x-6 gap-y-2 text-xs">
          {item.quantity !== undefined ? (
            <span className="inline-flex min-w-0 items-center gap-1">
              ...
              <span className="text-gray-500 break-words">{item.quantity}</span>
            </span>
          ) : null}
          ...
          {item.totalPrice !== undefined ? (
            <span className="inline-flex min-w-0 items-center gap-1">
              ...
              <span className="text-gray-500 break-words">{item.totalPrice}</span>
            </span>
          ) : null}
          ...
          {item.providerName ? (
            <span className="inline-flex min-w-0 items-center gap-1">
              ...
              <span className="text-gray-500 break-words">{item.providerName}</span>
            </span>
          ) : null}
          ...
          {item.buyDate ? (
            <span className="inline-flex min-w-0 items-center gap-1">
              ...
              <span className="text-gray-500 break-words">{item.buyDate}</span>
            </span>
          ) : null}
        </div>
      </div>
